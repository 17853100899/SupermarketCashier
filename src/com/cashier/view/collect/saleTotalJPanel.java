...
public class saleTotalJPanel extends javax.swing.JPanel implements ActionListener {
				...
				jTabbedPane1.setBounds(12, 18, 681, 318);
				{
					...
					}
					{
						...
						jScrollPane1.setBounds(5, 90, 666, 201);
						{
							...
							tableModel.setDataVector(totaldb.getSaleWare(), totaldb.getSaleColoumn());
							jTable1 = new JTable();
				...
				}
				{
					...
					}
					{
						...
						jScrollPane2.setBounds(0, 83, 676, 201);
						{
							...
							tableModel2.setDataVector(totaldb.getSaletotal("2010-12-12", "2012-12-31"),
									totaldb.getSaleTotalColoumn());
							jTable2 = new JTable();
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() == jButton1) {
			...
			tableModel.setDataVector(totaldb.getSaleWare(start, end), totaldb.getSaleColoumn());
		...
		if (e.getSource() == jButton2) {
			...
			tableModel2.setDataVector(totaldb.getSaletotal(start, end), totaldb.getSaleTotalColoumn());
